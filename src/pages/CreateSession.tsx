            ...
            {(Object.keys(pollTypeConfig) as SessionType[]).map((type) => {
              ...
              return (
                <motion.button
                  ...
                  className={`p-4 rounded-xl border-2 transition-all text-left ${pollType === type
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-2 grid grid-cols-2 gap-1">
                              {q.options.map((opt, optIdx) => (
                                <div
                                  key={optIdx}
                                  className={`text-xs px-2 py-1 rounded ${opt.is_correct
            ...
            <Card variant="elevated">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <motion.button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all text-left ${modes.paceMode === 'instructor'
                          ? "border-primary bg-primary/5"
                          : "border-border hover:border-primary/50"
                        }`}
                    >
                    ...
                    <motion.button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all text-left ${modes.paceMode === 'self-paced'
                          ? "border-primary bg-primary/5"
                          : "border-border hover:border-primary/50"
                        }`}
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <motion.button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all text-left ${modes.identityMode === 'anonymous'
                          ? "border-primary bg-primary/5"
                          : "border-border hover:border-primary/50"
                        }`}
                    >
                    ...
                    <motion.button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all text-left ${modes.identityMode === 'named'
                          ? "border-primary bg-primary/5"
                          : "border-border hover:border-primary/50"
                        }`}
                    >
                ...
                <div className="space-y-4">
                  ...
                  {/* Chaos Mode */}
                  <div className={`flex items-center justify-between p-4 rounded-xl border transition-colors ${modes.chaosMode
                      ? 'border-spark-coral bg-gradient-to-r from-spark-coral/10 to-amber-500/10'
                      : 'border-border hover:border-primary/30'
                    }`}>
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${modes.chaosMode
